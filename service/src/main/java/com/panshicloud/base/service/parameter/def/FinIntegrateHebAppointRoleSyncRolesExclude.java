 ...
 * @date 2023/5/8
 */
public class FinIntegrateHebAppointRoleSyncRolesExclude extends AbstractParameter {

    @Override
    public String code() {
        return "FinIntegrateHebAppointRoleSyncRolesExclude";
    }
    ...
    public String description() {
        return "禁用角色同步单位权限 用户角色编码 （一个或多个，逗号隔开）";
    }
